...
public class CommonAdapter extends RecyclerView.Adapter<CommonAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final CommonAdapter.MyViewHolder holder, final int position) {
        ...
        if(items.get(position).getWeight()!=null && !items.get(position).getWeight().equalsIgnoreCase("0.00000000")){
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout items_bg, add_to_cart,fav,background,poss,product;
        ...
        public MyViewHolder(View itemView) {
            ...
            items_bg = (LinearLayout) itemView.findViewById(R.id.items_bg);
            ...
            poss = (LinearLayout) itemView.findViewById(R.id.pos);
