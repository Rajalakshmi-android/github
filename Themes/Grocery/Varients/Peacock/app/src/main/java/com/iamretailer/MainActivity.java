...
public class MainActivity extends Drawer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cat_no_items=(TextView)findViewById(R.id.cat_no_items);
    ...
    private class GetVersionCode extends AsyncTask<Void, String, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            String newsize = null;
            Log.i("tag","paystore------ "+currentVersion);
            try {
            ...
            Log.d("paystore_update", "Current version " + currentVersion + "playstore version " + newVersion + "size" + newsize);
