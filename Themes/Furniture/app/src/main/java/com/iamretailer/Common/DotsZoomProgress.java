...
public class DotsZoomProgress extends View {
    ...
    public DotsZoomProgress(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            colorArc = array.getColor(R.styleable.DotsZoomProgress_inner_color,getResources().getColor(R.color.white));
            outRad = array.getDimension(R.styleable.DotsZoomProgress_outer_radius, 90);
            colorArc2 = array.getColor(R.styleable.DotsZoomProgress_outer_color,getResources().getColor(R.color.white));
            midRad = array.getDimension(R.styleable.DotsZoomProgress_mid_radius, 70);
            colorArc3 = array.getColor(R.styleable.DotsZoomProgress_mid_color,getResources().getColor(R.color.white));
