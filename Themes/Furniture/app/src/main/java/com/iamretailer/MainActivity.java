...
public class MainActivity extends Drawer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        no_cat_found = (TextView) findViewById(R.id.no_cat_found);
        ...
        cat_seall.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (level == 0) {
        ...
        try {
            if (ContextCompat.checkSelfPermission(MainActivity.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale
                    ...
                    Snackbar.make(findViewById(android.R.id.content), getResources().getString(R.string.per_msg), Snackbar.LENGTH_INDEFINITE).setAction(R.string.enable,
                            new OnClickListener() {
                                @Override
                                public void onClick(View v) {
        ...
        view_all_best.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                best.putString("head", getResources().getString(R.string.most));
        ...
        view_all_feat.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                feat.putString("head", getResources().getString(R.string.newly));
    ...
    private void addLayoutss(final BrandsPO brandsbo, LinearLayout payment_list, int pos) {
        ...
        final FrameLayout error_network = (FrameLayout) convertView.findViewById(R.id.error_network);
        LinearLayout retry = (LinearLayout) convertView.findViewById(R.id.retry);
        Log.i("tag", "listview----");

        namess.setText(brandsbo.getStore_name() + "");
        GetProductTask cattask = new GetProductTask(no_proditems, product_list, product_success, product_loading, error_network);
    ...
    private class GetProductTask extends AsyncTask<String, Void, String> {
        ...
        FrameLayout product_successs, product_loadings, error_networks;

        public GetProductTask(TextView no_proditems, RecyclerView product_list, FrameLayout product_success, FrameLayout product_loading, FrameLayout error_network) {
            no_proditem = no_proditems;
            product_lists = product_list;
            product_successs = product_success;
            product_loadings = product_loading;
            error_networks = error_network;
            ...
            if (resp != null) {
                ...
                try {
                    ...
                    if (json.getInt("success") == 1) {
                            ...
                            if (arr.length() > 0) {
                                ...
                                if (arr.length() < 10) {
                                    for (int h = 0; h < arr.length(); h++) {
                                        ...
                                        productbO.add(bo);
                                        Log.i("tag", "imagesssss---- " + productbO.get(0).getProducturl());
                                    }
                                } else {
                                    for (int h = 0; h < 10; h++) {
                                        JSONObject obj = arr.getJSONObject(h);
                                        ...
                                        productbO.add(bo);
                                        Log.i("tag", "imagesssss111---- " + productbO.get(0).getProducturl());
                                    }
                                }
                            }
                            if (productbO.size() != 0) {
                                ...
                                error_networks.setVisibility(View.GONE);
                        ...
                        product_loadings.setVisibility(View.GONE);
                        product_successs.setVisibility(View.GONE);
                        error_networks.setVisibility(View.VISIBLE);
                        JSONArray array = json.getJSONArray("error");
                        Toast.makeText(MainActivity.this, array.getString(0) + "", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                ...
                try {
                    ...
                    if (json.getInt("success") == 1) {
                        ...
                        if (json.has("data")) {
                            ...
                            Log.i("tag", "imagesssss2222---- " + list.get(0).getProducturl());
