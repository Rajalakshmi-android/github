...
public class CommonAdapter extends RecyclerView.Adapter<CommonAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final CommonAdapter.MyViewHolder holder, final int position) {
        ...
        if(from==1){
            if(position==0){
                holder.poss.setVisibility(View.VISIBLE);
            }else{
                holder.poss.setVisibility(View.GONE);
            }
            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams((int) context.getResources().getDimension(R.dimen.dp150), RecyclerView.LayoutParams.WRAP_CONTENT);
            lp.setMarginEnd((int) context.getResources().getDimension(R.dimen.dp15));
            holder.products.setLayoutParams(lp);
        }else if (from==3)
        {
            if(position==0){
                ...
                holder.poss.setVisibility(View.VISIBLE);
                holder.poss.setLayoutParams(lp);

            }else{
                holder.poss.setVisibility(View.GONE);
            }
            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams((int) context.getResources().getDimension(R.dimen.dp150), RecyclerView.LayoutParams.WRAP_CONTENT);
            lp.setMarginEnd((int) context.getResources().getDimension(R.dimen.dp10));
            holder.products.setLayoutParams(lp);
            ...
            holder.products.setLayoutParams(lp1);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout items_bg, add_to_cart,fav,background,poss,products;
        ImageView r1, r2, r3, r4, r5;
        TextView sp_cur_left,sp_cur_right;
        ...
        public MyViewHolder(View itemView) {
            ...
            products=(LinearLayout)itemView.findViewById(R.id.products);
            poss=(LinearLayout)itemView.findViewById(R.id.poss);
