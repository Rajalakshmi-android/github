...
public class Appconstatants {
    ...
    public static String domain ="http://shopzenstage.stutzen.in/";//"http://shopzen.stutzen.in/";//"https://krstore.iamretailer.com/";//"http://shopzen.stutzen.in/";//"https://krstore.iamretailer.com/";//http://shopzenstage.stutzen.in/";//"http://shopzenstage.stutzen.in/";
