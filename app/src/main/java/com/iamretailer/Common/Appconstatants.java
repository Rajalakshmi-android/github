...
public class Appconstatants {
    ...
    public static String value="nuhgMM40tVc2alX3gmXlVJLdzPIc0AeL";//"cXPSUy2UUXFQqeKnHg44abn7ewySi3pz";//"nuhgMM40tVc2alX3gmXlVJLdzPIc0AeL";//"nuhgMM40tVc2alX3gmXlVJLdzPIc0AeL";//"nuhgMM40tVc2alX3gmXlVJLdzPIc0AeL";//"jgEtw1UZQHvvPhOVEuZt2Yn3WG63pHaa";//"jgEtw1UZQHvvPhOVEuZt2Yn3WG63pHaa";//"nuhgMM40tVc2alX3gmXlVJLdzPIc0AeL";//"cDXtRf72fHTPDz0Mp5OCFysHna10Ssjf";//"nuhgMM40tVc2alX3gmXlVJLdzPIc0AeL";

    public static String key1="X-Oc-Session";

    public static String domain ="http://shopzen.stutzen.in/";//"http://shopzenstage.stutzen.in/";//"http://shopzen.stutzen.in/";//"http://shopzen.stutzen.in/";//"https://krstore.iamretailer.com/";//"http://shopzen.stutzen.in/";//"https://krstore.iamretailer.com/";//http://shopzenstage.stutzen.in/";//"http://shopzenstage.stutzen.in/";
