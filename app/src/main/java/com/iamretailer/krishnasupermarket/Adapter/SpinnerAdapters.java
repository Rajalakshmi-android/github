...
public class SpinnerAdapters extends BaseAdapter {
    ...
    public SpinnerAdapters(Context context, ArrayList<SingleOptionPO> stateData, int from) {
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent, int loc) {
        ...
        View mySpinner = inflater.inflate(R.layout.drop_downitems, parent, false);
